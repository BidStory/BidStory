function dbi00(dbName) {
  let currentVersion = 1;
  //تفتح الاتصال اما برقم اصدار انت تعطية او هي تقوم بالفتح في اخر اصدار
...
//ياتي باخر اصدار من قاعدة البيانات
  ...
  const getAllIdTableData = async (tableName) => {
    let db;
    try {
      db = await openDB();
      return new Promise((resolve, reject) => {
