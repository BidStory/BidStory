...
// Examples:
// Single table:
// importOrUpdateFromJSON({ database: 'dataBaseName', table: 'newTable', schema: {...}, data: [...], exported_at: '...' });
// Multiple tables:
// importOrUpdateFromJSON({ database: 'dataBaseName', stores: [ { table: 'keyTable', schema: {...}, data: [...] }, { table: 'newTable', schema: {...}, data: [...] } ] });
